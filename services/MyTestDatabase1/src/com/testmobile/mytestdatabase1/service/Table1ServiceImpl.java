 ...
 */
@Service("MyTestDatabase1.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("MyTestDatabase1.Table1Dao")
    ...
    public void setWMGenericDao(WMGenericDao<Table1, Integer> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "MyTestDatabase1TransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "MyTestDatabase1TransactionManager")
    @Override
